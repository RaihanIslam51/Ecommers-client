    ...
    <header className="sticky top-0 z-40 w-full bg-white/95 backdrop-blur-xl border-b border-gray-200 shadow-sm">
      <div className="flex items-center justify-between h-16 px-4 lg:px-6 gap-4">
        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <button 
            onClick={onMenuClick}
            className="lg:hidden p-2.5 rounded-xl hover:bg-green-50 transition-all duration-200 group active:scale-95"
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Mobile Search Icon */}
          <button 
            className="md:hidden p-2.5 rounded-xl hover:bg-green-50 transition-all duration-200 group active:scale-95"
            aria-label="Search"
          >
          ...
          <button 
            ...
            className="hidden lg:block p-2.5 rounded-xl hover:bg-green-50 transition-all duration-200 group active:scale-95"
            aria-label="Toggle fullscreen"
            title={isFullscreen ? 'Exit Fullscreen (F11)' : 'Enter Fullscreen (F11)'}
          >
            {isFullscreen ? (
              <Minimize className="w-5 h-5 text-gray-600 group-hover:text-green-600 transition-colors" />
            ) : (
              <Maximize className="w-5 h-5 text-gray-600 group-hover:text-green-600 transition-colors" />
            )}
          </button>
          ...
          <div className="relative" ref={profileMenuRef}>
            <button 
              ...
              className="flex items-center gap-3 p-1.5 lg:pl-2 lg:pr-3 rounded-xl 
                       hover:bg-green-50 transition-all duration-200 group active:scale-95"
              aria-label="User menu"
            >
              <div className="relative">
                <div className="w-9 h-9 rounded-full bg-linear-to-br from-green-600 to-emerald-600 
                              flex items-center justify-center text-white font-bold text-sm
                              ring-2 ring-green-100 shadow-md group-hover:ring-green-200 transition-all">
                  {user.avatar}
                </div>
              ...
              <ChevronDown className="hidden lg:block w-4 h-4 text-gray-400 group-hover:text-green-600 transition-colors" />
            </button>
            ...
            {showProfileMenu && (
              <div className="absolute right-0 mt-3 w-72 bg-white rounded-2xl shadow-2xl border border-gray-200 
                ...
                {/* Profile Header */}
                <div className="p-4 border-b border-gray-100 bg-linear-to-br from-green-50 to-emerald-50">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-linear-to-br from-green-600 to-emerald-600 
                ...
                <div className="py-2">
                  <button className="w-full px-4 py-3 text-left flex items-center gap-3 
                                 hover:bg-green-50 transition-all duration-150 group">
                  ...
                  <button className="w-full px-4 py-3 text-left flex items-center gap-3 
                                 hover:bg-green-50 transition-all duration-150 group">
                    <div className="p-2 rounded-lg bg-lime-50 group-hover:bg-lime-100 transition-colors">
