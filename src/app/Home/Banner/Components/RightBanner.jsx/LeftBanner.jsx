...
const LeftBanner = () => {
  return (
    <div className="relative w-full h-64 md:h-96 bg-gray-200 rounded-lg overflow-hidden shadow-lg">
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col justify-center h-full px-4 md:px-6 text-white">
        ...
        <button className="bg-green-600 hover:bg-green-700 transition text-white px-3 py-2 md:px-5 md:py-3 rounded-lg font-semibold w-max">
          Explore
        </button>
      </div>
    </div>
