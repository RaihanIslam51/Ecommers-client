...
const CONTACT_INFO = {
  ...
  phone: "+880 1956-486761",
  address: {
    building: "Kusholi Bhaban, 4th Floor",
    street: "238/1 Begum Rokeya Sharani",
    city: "Agargaon, Dhaka-1207",
    country: "Bangladesh",
  },
  officePhones: ["09609 016810", "+880 1755 513900"],
};
...
const ContactInfo = () => (
  <div className="text-sm text-gray-400 space-y-2">
    <div className="flex items-center gap-2">
      <FaEnvelope className="text-gray-500 shrink-0" size={14} />
      <a
    ...
    <div className="flex items-center gap-2">
      <FaPhone className="text-gray-500 shrink-0" size={14} />
      <a
...
const BrandSection = () => (
  <div className="space-y-6">
    <div>
      <h2 className="text-2xl font-black mb-3 tracking-tight">BDMart</h2>
      <p className="text-sm text-gray-400 leading-relaxed">
        Your trusted global marketplace for quality products, fast shipping, and
        exceptional service.
      </p>
    </div>
    <NewsletterForm />
