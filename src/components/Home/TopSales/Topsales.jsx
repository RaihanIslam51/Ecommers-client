      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8 md:mb-10 lg:mb-12">
          <div>
            ...
            <p className="text-sm md:text-base text-gray-600 font-light ml-0 lg:ml-0">Discover our best-selling fresh vegetables and healthy meal kits</p>
          </div>
            ...
            <div className="bg-white p-6 md:p-8 w-full max-w-4xl relative shadow-2xl grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 animate-slide-up border border-gray-200">
              ...
              <div className="flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-4 font-light">{modalProduct.feature}</p>
                  ...
                  <div className="inline-flex items-center px-3 py-1 bg-gray-100 border border-gray-200 mb-4">
                    <span className="text-sm text-gray-700 font-light">
                      <span className="font-light text-black">{modalProduct.salesCount}</span> sold
                    </span>
                  </div>

                  {/* Description */}
                  <p className="text-gray-700 leading-relaxed font-light">{modalProduct.description}</p>
                </div>

                {/* Actions */}
                <div className="mt-6 flex items-center gap-3">
                  <button className="flex-1 px-6 py-3 bg-black text-white font-light hover:bg-gray-900 transition-colors duration-200">
                    Add to Cart
                  </button>
